 ...
 * 
 * 1、新增按钮
 *  - addShow: 是否显示该按钮（布尔值-默认显示）
 *  - addValue: 该按钮跳转的路由，格式为字符串
 * 
 * 2、筛选菜单
 *  - selectShow: 是否显示该子组件（布尔值-默认显示）
 *  - selectValue: 该组件渲染的数据，格式为直接显示内容的一维数组
 *  - 数据格式的例子：['javaScript', 'css', 'python']
 * 
 * 3、删除按钮（列表内勾选删除）
 *  - delShow: 是否显示该按钮（布尔值-默认不显示）
 *  - delValue: 删除数据的后台接口，格式为字符串
